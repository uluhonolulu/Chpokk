...
namespace $safeprojectname$
{
    ...
    /// </summary>
    class $safeprojectname$ : Canvas, IWpfTextViewMargin
    {
        public const string MarginName = "$safeprojectname$";
        ...
        public $safeprojectname$(IWpfTextView textView)
        {
            _textView = textView;
        ...
        {
            return (marginName == $safeprojectname$.MarginName) ? (IWpfTextViewMargin)this : null;
        }
