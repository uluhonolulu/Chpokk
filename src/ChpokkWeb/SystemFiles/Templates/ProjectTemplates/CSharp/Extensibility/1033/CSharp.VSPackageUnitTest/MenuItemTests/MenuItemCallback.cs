...
namespace $safeprojectname$.MenuItemTests
{
    ...
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new $packageClass$Package() as IVsPackage;
            ...
            BaseMock registerEditor = $safeprojectname$.EditorTests.RegisterEditorsServiceMock.GetRegisterEditorsInstance();
            ...
            CommandID menuCommandID = new CommandID($packageNamespace$.GuidList.$packageCmdSetGuid$, (int)$packageNamespace$.PkgCmdIDList.$cmdidMenuItem$);
