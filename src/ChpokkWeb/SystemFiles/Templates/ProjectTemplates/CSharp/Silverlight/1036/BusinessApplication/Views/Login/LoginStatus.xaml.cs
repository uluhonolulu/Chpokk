namespace $safeprojectname$.LoginUI
{
    ...
    /// <summary>
    /// Classe <see cref="UserControl"/> qui affiche l'état de connexion actuel et permet la connexion et la déconnexion.
    /// </summary>
    public partial class LoginStatus : UserControl
    {
        /// <summary>
        /// Crée une nouvelle instance <see cref="LoginStatus"/>.
        /// </summary>
        public LoginStatus()
        {
