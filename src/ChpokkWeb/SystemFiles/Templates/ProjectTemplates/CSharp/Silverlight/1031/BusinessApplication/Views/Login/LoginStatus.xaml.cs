namespace $safeprojectname$.LoginUI
{
    ...
    /// <summary>
    /// <see cref="UserControl"/> Klasse, die den derzeitigen Anmeldestatus anzeigt und das Anmelden und Abmelden zulässt.
    /// </summary>
    public partial class LoginStatus : UserControl
    {
        /// <summary>
        /// Erstellt eine neue Instanz von <see cref="LoginStatus"/>.
        /// </summary>
        public LoginStatus()
        {
