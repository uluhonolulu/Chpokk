namespace $safeprojectname$
{
    ...
    /// <summary>
    /// Clase que contiene los valores y las reglas de validación para el registro de usuarios.
    /// </summary>
    public sealed partial class RegistrationData
    {
        ...
        /// <summary>
        /// Obtiene y establece la dirección de correo electrónico.
        /// </summary>
        [Required(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(ValidationErrorResources))]
        ...
        /// <summary>
        /// Obtiene y establece la pregunta de seguridad.
        /// </summary>
        [Required(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(ValidationErrorResources))]
        ...
        /// <summary>
        /// Obtiene y establece la respuesta a la pregunta de seguridad.
        /// </summary>
        [Required(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(ValidationErrorResources))]
