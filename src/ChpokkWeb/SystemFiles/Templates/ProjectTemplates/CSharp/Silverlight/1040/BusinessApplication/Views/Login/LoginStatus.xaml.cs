namespace $safeprojectname$.LoginUI
{
    ...
    /// <summary>
    /// Classe <see cref="UserControl"/> che mostra lo stato di accesso corrente e consente l'accesso e la disconnessione.
    /// </summary>
    public partial class LoginStatus : UserControl
    {
        /// <summary>
        /// Crea una nuova istanza di <see cref="LoginStatus"/>.
        /// </summary>
        public LoginStatus()
        {
