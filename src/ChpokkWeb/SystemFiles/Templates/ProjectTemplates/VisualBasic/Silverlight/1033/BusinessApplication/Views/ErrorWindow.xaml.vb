...
''' <summary>
''' Controls when a stack trace should be displayed on the ErrorWindow.
''' Defaults to <see cref="StackTracePolicy.OnlyWhenDebuggingOrRunningLocally"/>
''' </summary>
Public Enum StackTracePolicy
    ''' <summary>
    ''' Stack trace is showed only when running with a debugger attached or when running the app on the local machine.
...
#Region "Factory Helpers"
    ...
    ''' Currently this simply takes the Exception.Message value.
