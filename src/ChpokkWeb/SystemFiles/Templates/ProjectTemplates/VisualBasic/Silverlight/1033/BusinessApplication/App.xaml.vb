...
Partial Public Class App
    ...
    ''' The LoadUser operation will cause user to be logged automatically if using Windows authentication or if the user had selected the "Keep me signed in" option on a previous login.
    ''' </summary>
