...
Namespace $safeprojectname$
    ...
    Public Class MenuItemTest
        ...
        Private Sub AnonymousMethod1()
            ...
            Dim menuItemCmd As CommandID = New CommandID(GuidList.$packageCmdSetGuid$, PkgCmdIDList.$cmdidMenuItem$)

            ' Create the DialogBoxListener Thread.
            Dim expectedDialogBoxText As String = String.Format(CultureInfo.CurrentUICulture, "{0}" & _
                                                                vbLf & _
                                                                vbLf & _
                                                                "Inside {1}.MenuItemCallback()", "$packageName$", "$packageClass$Package")
            Dim purger As Microsoft.VsSDK.IntegrationTestLibrary.DialogBoxPurger = New Microsoft.VsSDK.IntegrationTestLibrary.DialogBoxPurger(Microsoft.VsSDK.IntegrationTestLibrary.NativeMethods.IDOK, expectedDialogBoxText)
